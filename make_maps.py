...
def main():
    ...
    for baryon_feedback in [7.0, 10.0]:
        for label, theta in thetas_to_run.items():
            save_dir = f"/srv/scratch2/taylor.4264/BNTSmooth_data/maps/maps_{label}_b{int(baryon_feedback)}"
            ...
            print(f"\nLaunching {label} simulations for baryon_feedback = {baryon_feedback}")
